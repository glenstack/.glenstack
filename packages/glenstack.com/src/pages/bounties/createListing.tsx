...
export const CreateListing: FC = () => {
  ...
  const isEditing = new URLSearchParams(search).get("edit");

  const [title, setTitle] = useState<{ title: string }>(
    isEditing ? bounties[id].title : ""
  );
  const [description, setDescription] = useState<{ description: string }>(
    isEditing ? bounties[id].description : ""
  );
  const [offer, setOffer] = useState<{ offer: string }>(
    isEditing ? bounties[id].offer : ""
  );
  return (
    <>
          ...
          <header className="max-w-7xl mx-auto flex py-10">
            <div className=" px-4 sm:px-6 lg:px-8">
              <h1 className="text-3xl font-bold text-white">
                {isEditing ? "Edit " : "Create"} your listing
              </h1>
            </div>
          </header>
        </div>
                ...
                <div className="space-y-8 divide-y divide-gray-200 sm:space-y-5">
                  <div>
                    <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-gray-200 sm:pt-5">
                      ...
                      <p className="mt-1 max-w-2xl text-sm text-gray-500">
                        Briefly explain what sort of dataset you're looking for
                      </p>
                    </div>
                      ...
                      <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-gray-200 sm:pt-5">
                        ...
                        <div className="mt-1 sm:mt-0 sm:col-span-2">
                          ...
                          <p className="mt-2 text-sm text-gray-500">
                            Explain in detail the requirements you're looking
                            for in your dataset
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="mt-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                      ...
                      <p className="mt-1 max-w-2xl text-sm text-gray-500">
                        What you'd willing to offer for the dataset: £1, £100,
                        £negotiable etc.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
                    <div>
                      ...
                      <p className="mt-1 max-w-2xl text-sm text-gray-500">
                        Your information will not be listed publicly, we'll
                        simply forward on any responses to your listing.
                      </p>
                    </div>
