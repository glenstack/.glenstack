              ...
              <div className="mt-20">
                <div>
                  <a href="/" className="inline-flex space-x-4">
                    ...
                    <span className="inline-flex items-center text-sm font-medium text-rose-500 space-x-1">
                      <span>v1.0.0 under active development</span>
                ...
                <div className="mt-6 sm:max-w-xl">
                  ...
                  <p className="mt-6 text-xl text-gray-500">
                    Glenstack Bases provide a new way to store and access your
                    data: build an entire application, or just keep a list of
                ...
                >
                  ...
                  <div className="mt-4 sm:mt-0 sm:ml-3">
                    <button
                      ...
                      onClick={() => registerEmail(emailAddress)}
                ...
                <div className="mt-4 lg:mt-6 sm:max-w-lg text-lg text-rose-900">
                    ...
                    <blockquote className="mt-8">
                      <div className="relative text-lg font-medium text-white md:flex-grow">
                        ...
                        <p className="relative">
                          Glenstack Bases represent a shift in the way people
                          want to store and handle data. This platform will
            ...
            <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
              ...
              <div className="pt-12 sm:pt-16 lg:pt-20">
                ...
                <div className="mt-6 text-gray-500 space-y-6">
                  <p className="text-lg">
                    Glenstack Bases are part of an ecosystem that enables you to
                    use data in completely new ways. We can't wait to see what
                    you build with it.
                  </p>
                  <p className="text-base leading-7">
                    We recognize that a growing number of people have valuable
                    data that they want to sell. We want to give you an
                    effective place to do that. Simply upload your data, create
                    a listing, and set your price. Buyers get immediate access
                    and can
                  </p>
                  <p className="text-base leading-7">
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-24 lg:items-center">
              <div>
                <h2 className="text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">
                  A high-quality data marketplace for buyers and sellers alike
                </h2>
                <p className="mt-6 max-w-3xl text-xl leading-7 text-gray-500">
                  Curate datasets and sell them on our marketplace. Or,
                  subscribe to premium Bases for high-quality and up-to-date
                  information.
                </p>
                <p className="mt-4 max-w-3xl text-lg leading-7 text-gray-500">
                  We recognize that a growing number of people have valuable
                  data that they want to sell. We want to give you an effective
                  place to do that! Simply upload your data, create a listing,
                  and set your price. Buyers get immediate access and can
                  combine it with their own data to really take advantage of all
                  that you can offer.
                </p>
                <div className="mt-6">
                  <a href="/" className="text-base font-medium text-rose-500">
                    More about becoming a seller on Glenstack&nbsp;→
                  </a>
                </div>
              </div>
          ...
          <div className="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="relative rounded-2xl px-6 py-10 bg-rose-500 overflow-hidden shadow-xl sm:px-12 sm:py-20">
              ...
              <div className="relative">
                ...
                >
                  <div className="min-w-0 flex-1">
                    ...
                    <input
                      ...
                      placeholder="Enter your email"
                      value={emailAddress2}
                      onChange={(event) => setEmailAddress2(event.target.value)}
                    />
                  </div>
                  <div className="mt-4 sm:mt-0 sm:ml-3">
                    <button
                      ...
                      onClick={() => registerEmail(emailAddress2)}
                      disabled={loading || result ? true : false}
                    >
                      Notify me
                    </button>
                ...
                <div className="mt-6 mx-auto max-w-2xl font-medium text-lg text-rose-100 sm:text-center">
                  {error ? error : result ? <Result result={result} /> : ""}
                </div>
              </div>
            </div>
      ...
      <footer className="mt-24 bg-gray-900 sm:mt-12">
        <div className="mx-auto max-w-md py-12 px-4 overflow-hidden sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <p className="mt-8 text-center text-base text-gray-400">
            © 2021 Glenstack. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
