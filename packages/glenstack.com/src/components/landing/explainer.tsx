      ...
      <div className="relative max-w-xl mx-auto px-4 sm:px-6 lg:px-8 lg:max-w-7xl">
        ...
        <div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
          ...
          <span className="mb-10 rounded-xl bg-rose-50 px-2.5 py-1 text-xs font-semibold text-rose-600 tracking-wide uppercase">
            ...
            <h3 className="mt-3 text-2xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">
              Seamlessly create and <br></br>access your data <span className="text-rose-600">without code</span>.
            </h3>
        ...
        <div className="relative mt-12 sm:mt-16 lg:mt-24">
          <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
            ...
            <span className="mb-10 rounded-xl bg-yellow-50 px-2.5 py-1 text-xs font-semibold text-yellow-500 tracking-wide uppercase">
              ...
              <h3 className="mt-3 text-2xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">Easily collaborate on data<br></br> with your team,<br></br>or the <span className="text-yellow-500">entire world</span>.</h3>
              <p className="mt-3 text-lg text-gray-500">
                Glenstack makes it easy to collaborate live on data with your team.
                You can also crowdsource your data and allow external collaborators to submit data that to be approved by your team.
        ...
        <div className="relative mt-12 lg:mt-24 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
          ...
          <span className="mb-10 rounded-xl bg-rose-50 px-2.5 py-1 text-xs font-semibold text-rose-600 tracking-wide uppercase">
            ...
            <h3 className="mt-3 text-2xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">
            Share or access live, ready-to-query<br></br>data from our <span className="text-rose-600">marketplace</span>.
            </h3>
            <p className="mt-3 text-lg text-gray-500">
              Share or sell your data on our data marketplace and build a business on top of your data.
              Access third-party data to power your app or provide deeper insights to your organization.
            </p>
