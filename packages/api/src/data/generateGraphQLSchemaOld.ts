...
// generate books and authors queries
const generateQueryTypes = async (tables: Array) => {};

// generate Book and Author
const generateObjectTypes = async (tables: Array) => {
  let registeredObjectTypes = {};

  const registerObjectTypeRecursively = () => {};
};

export const generateGraphQLSchema = async (projectData: Object) => {
